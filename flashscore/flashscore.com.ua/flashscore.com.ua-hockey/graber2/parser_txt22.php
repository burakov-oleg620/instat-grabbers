		...
		if (count ($temp1) > 1) {
			...
			if ($temp1[0] != '-') {
				...
				*/
				...
				//$insert ['round'] = $temp1[15];
				//$insert ['round_id'] = $temp1[16];
				
				// $insert['competition'] = $temp1[13];
				// $insert['competition_id'] = $temp1[14];
				
				// $insert['competition'] = $temp1[19];
				// $insert['competition_id'] = $temp1[20];

				$insert['competition'] = $temp1[27].':'.$temp1[28];
				$insert['competition'] = preg_replace ('/^:|:$/ui', '', $insert['competition']);
				$insert['competition_id'] = $temp1[26];
				
				
				//$insert ['home_team_full_name'] = $temp1[3];
				$insert ['home_team_full_name_ru'] = $temp1[3];
				$insert ['home_team_short_name'] = $temp1[4];
				$insert ['home_team_id'] = $temp1[5];
				$insert ['home_team_name_en'] = $temp1[6];
				
				//$insert ['away_team_full_name'] = $temp1[7];
				$insert ['away_team_full_name_ru'] = $temp1[7];
				$insert ['away_team_short_name'] = $temp1[8];
				$insert ['away_team_id'] = $temp1[9];
				$insert ['away_team_name_en'] = $temp1[10];
				
				$insert ['home_score'] = $temp1[11];
				$insert ['away_score'] = $temp1[12];
				$insert ['type'] = $temp1[17];
				$insert ['country'] = $temp1[18];
				
				$insert ['home_score_main_time'] = $temp1[21];
				$insert ['away_score_main_time'] = $temp1[22];
				
				$insert ['home_score_overtime'] = $temp1[23];
				$insert ['away_score_overtime'] = $temp1[24];
				
				$insert ['match_status'] = $temp1[29];
				$insert ['referee1'] = 	$temp1[30];
				$insert ['referee2'] = $temp1[31];
				$insert ['stadium'] = $temp1[32];
				
				
				$insert ['home_score_without_bullits'] = (int) $temp1[21] + (int) $temp1[23];
				$insert ['away_score_without_bullits'] = (int) $temp1[22] + (int) $temp1[24];
				
				$insert ['home_score_without_bullits'] = trim ($insert ['home_score_without_bullits']);
				$insert ['away_score_without_bullits'] = trim ($insert ['away_score_without_bullits']);
				if ($insert ['home_score_without_bullits'] == '') {$insert ['home_score_without_bullits'] = 0;}
				if ($insert ['away_score_without_bullits'] == '') {$insert ['away_score_without_bullits'] = 0;}

				$insert ['competition_path'] = $temp1[25];
...
function post ($postdata) {
	...
	$url =  'http://data.instatfootball.tv/api/import2?key='.$key_import2.'&method=UpdateHockeyMyscoreMatches';
