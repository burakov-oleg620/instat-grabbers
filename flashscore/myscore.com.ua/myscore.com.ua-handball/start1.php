	...
	if (count ($file_array) > 0) {
		foreach ($file_array as $file_array_value) {
			...
			if (is_dir ($workdir2)) {
				...
				fwrite ($fh, $t[0] ."\t". 1 . "\n");
				// fwrite ($fh, $t[0] .'games-schedule.asp?year=2018-2019&women=0'."\t". 1 . "\n");
				// fwrite ($fh, $t[0] .'games-schedule.asp?year=2018-2019&women=1'."\t". 1 . "\n");
				// fwrite ($fh, $file_array_value .'games-schedule.asp?year=2018-2019&women=0'."\n");
				// fwrite ($fh, $file_array_value .'games-schedule.asp?year=2018-2019&women=1'."\n");
				fclose ($fh);
			...
			if (is_dir ($workdir3)) {
				...
				// fwrite ($fh, $t[0] .'games-schedule.asp?year='.$date1.'-'.$date2.'&women=0'."\t". 1 . "\n");
				// fwrite ($fh, $t[0] .'games-schedule.asp?year='.$date1.'-'.$date2.'&women=1'."\t". 1 . "\n");
