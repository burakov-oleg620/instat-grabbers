		...
		if (count ($temp1) > 1) {
			...
			if ($temp1[0] != '-') {
				...
				*/
				...
				$insert ['competition_path'] = $temp1[21];
				$insert ['match_status'] = $temp1[25];
				$insert ['round'] = $temp1[26];
				$insert ['stadium'] = $temp1[27];
...
function post ($postdata) {
	...
	$url =  'http://data.instatfootball.tv/api/import2?key='.$key_import2.'&method=UpdateBasketballMyscoreMatches';
