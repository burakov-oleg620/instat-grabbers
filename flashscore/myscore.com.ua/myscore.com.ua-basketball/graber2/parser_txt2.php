		...
		if (count ($temp1) > 0) {
			...
			if ($temp1[0] != '-') {
				...
				*/
				...
				//$insert ['away_team_full_name_ru'] = $temp1[8];
				...
				if (isset ($file4_array[$temp1[21]])) {
					
					$insert ['season_url']	= $temp1[21];
					$insert ['season']	= $file4_array[$temp1[21]];
				...
				if (preg_match ('/^http/', $temp1[0]) and mb_strlen ($temp1[0]) < 255) { 
...
function post ($postdata) {
	...
	$url =  'https://data.instatfootball.tv/api/import2?key='.$key_import2.'&method=UpdateBasketballMyscoreMatches';
