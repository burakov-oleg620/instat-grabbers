		...
		if (count ($temp1) > 1) {
			...
			if ($temp1[0] != '-') {
				...
				*/
				...
				$insert ['name'] = $temp1[2];
				$insert ['type'] = $temp1[3];
				$insert ['nationality_code'] = $temp1[4];
				$insert ['first_name'] = $temp1[5];
				$insert ['last_name'] = $temp1[6];
				$insert ['date_of_birth'] = $temp1[7];
				$insert ['place_of_birth'] = $temp1[8];
				
				$insert ['height'] = $temp1[9];
				$insert ['weight'] = $temp1[10];
				$insert ['team_id'] = $temp1[11];
				$insert ['img'] = $temp1[12];
				$insert ['actual_date'] = $temp1[13];
				$insert ['source_data'] = '';
...
function post ($postdata) {
	...
	$url = 'http://data.instatfootball.tv/api/import2?key='.$key_import2.'&method=UpdateBasketballEurobasketCoaches';
	...
	if ($httpcode == 200) {
		...
		$file = $workdir .'/txt/post_json_coaches.html';
