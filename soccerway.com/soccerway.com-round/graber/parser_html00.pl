...
while (my $file1 = $dir_scan_recurce -> get_file ()) {
	...
	if ($file1 =~ /$pattern/) {	
		...
		# #Категория
		# @array = ();
		# $pattern1 = '(<ul class="breadcrumbs.+?</ul>)';
		# $work_for_content = work_for_content -> new ($content1); 
		# $work_for_content_result = $work_for_content -> get_pattern ($pattern1); 
		# if (defined $work_for_content_result -> [0]) {
			# foreach (@$work_for_content_result) {		
		...
		# #Бренд
		# @array = ();
		# $pattern1 = '<div class="headline.+?(<h1.+?</h1>)';
		# $work_for_content = work_for_content -> new ($content1); 
		# $work_for_content_result = $work_for_content -> get_pattern ($pattern1); 
		# if (defined $work_for_content_result -> [0]) {
			# foreach (@$work_for_content_result) {		
		...
		# #описание
		# @array = ();
		# $pattern1 = '(<ul class="product-card__spec">.+?</ul>)';
		# $work_for_content = work_for_content -> new ($content1); 
		# $work_for_content_result = $work_for_content -> get_pattern ($pattern1); 
		# if (defined $work_for_content_result -> [0]) {
			# foreach (@$work_for_content_result) {		
		...
		# #Цена
		# @array = ();
		# $pattern1 = '<div class="product-card__price-value">(.+?)<';
		# $work_for_content = work_for_content -> new ($content1); 
		# $work_for_content_result = $work_for_content -> get_pattern ($pattern1); 
		# if (defined $work_for_content_result -> [0]) {
			# foreach (@$work_for_content_result) {		
		...
		# #ссылка на описание
		# @array = ();
		# $pattern1 = '(<div class="product-card__spec-text-more">.+?</div>)';
		# $work_for_content = work_for_content -> new ($content1); 
		# $work_for_content_result = $work_for_content -> get_pattern ($pattern1); 
		# if (defined $work_for_content_result -> [0]) {
			# foreach (@$work_for_content_result) {		
