...
$_GET['url'] = 'https://int.soccerway.com/national/latvia/virsliga/2022/regular-season/r66541/';
if (
	

	isset ($_GET['url']) and preg_match ('/^http/ui', $_GET['url'])
	...
	$sql = 'insert ignore into roundstasks (
		md5,
		url,
		file,
		type
	...
	$query = mysqli_query ($connect, $sql) or print mysqli_errno ($connect).  ": " . mysqli_error($connect)."\n";;


	$array = array ();
	$sql = 'select * from roundstasks';
	$query = mysqli_query ($connect, $sql) or print mysqli_errno ($connect).  ": " . mysqli_error($connect)."\n";;
	...
	while ($row = mysqli_fetch_array ($query)) {
		...
		// $sql = 'delete from roundstasks where md5 = "'.$row['md5'].'"';
		// $query1 = mysqli_query ($connect, $sql) or print mysqli_errno ($connect).  ": " . mysqli_error($connect)."\n";;
